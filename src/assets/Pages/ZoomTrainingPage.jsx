      ...
      <div className="zoom-training-page">
        <div className="training-page-header">
          <div className="left-training-header">
            <p className="left-training">Training via Zoom</p>
          </div>
        </div>
        <div className="zoom-training-card">
          <img src="ZoomLinkIcon.svg" alt="" className="zoom-icon" />
          <p className="zoom-card-txt">
            Training: Communicating Effectively with Vulnerable Children and
            Young People
          </p>
        ...
        <button className="d-flex mx-auto back-train-btn" onClick={goBackTraining}>
          Back to training
        </button>
      </div>
    </div>
