      ...
      <Modal.Body>
        <form action="#" className="schedule-form" id="schdform" required>
          ...
          <div className="d-flex gap-3">
            ...
            />
            <div className="cs-form d-inline w-100">
              <input
                type="time"
...
const SchedulePage = () => {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#eaeaea" }}>
      <Helmet>
        ...
        <div className="card p-3 bg-white border-0 shadow">
          <div className="card-body">
            <div className="schedule-page">
              <Row>
                <Col lg={9}>
                  <div className="schedule-calendar overflow-hidden">
                    <Calendar onModalShow={handleModalShow} />
                  </div>
                </Col>
                <Col lg={3}>
                  <div className="right-schedule-col overflow-hidden">
                    <div className="right-schedule-header" style={{ marginTop: 32 }}>
                      <button
